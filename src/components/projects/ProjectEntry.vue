<template>
    <a :href="url" target="_blank">
        <div
            class="flex justify-center space-x-6 transition ease-in-out hover:-translate-y-2 m-4 hover:shadow-2xl"
        >
            <div class="font-maven shadow-lg p-4">
                ...
                <div class="flex justify-items-start space-x-4 text-neutral-400 text-sm mt-3">
